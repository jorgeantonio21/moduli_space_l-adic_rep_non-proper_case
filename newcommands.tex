...
\newcommand{\dLocSys}{\mathbf R \mathrm{LocSys}_{\ell, n}}
\newcommand{\abdLocSys}{\mathbf R \mathrm{LocSys}_{\ell, n, \Gamma}}
...
\newcommand{\PerfSys}{\mathcal{P} \mathrm{erf}^{\otimes}_{\ell}}
